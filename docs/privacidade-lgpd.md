...
Registradores (ARISP): Consulta de Informações da Conta segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [registradores_info_conta@mcp.ai](mailto:registradores_info_conta@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
